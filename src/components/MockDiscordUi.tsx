...
interface MockDiscordUiProps {
  children: React.ReactNode
}

const MockDiscordUi = ({ children }: MockDiscordUiProps) => {
  return (
    <div
      className={"flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl"}>
      <div className={"hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center"}>
        ...
        <div
          className={"size-12 mt-auto bg-discord-background group rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-[#3ba55c] cursor-not-allowed hover:text-white"}>
          <PlusCircle className={"text-[#3ba55c] group-hover:text-white hover:text-white"} />
        </div>
      </div>
      ...
      <div className={"hidden md:flex w-60 bg-[#2f3136] flex-col"}>
        <div className={"px-4 h-16 border-b border-[#202225] flex items-center shadow-sm"}>
          <div
            className={"w-full bg-[#202225] h-8 flex items-center text-sm rounded px-2 justify-center text-gray-500 cursor-not-allowed"}>
        ...
        <div className={"flex-1 overflow-y-auto pt-4"}>
          ...
          <div className={"px-2 mb-4"}>
            ...
            <div className={"flex items-center px-2 py-1.5 rounded-bg-[#393c43] text-white cursor-pointer"}>
              <Image src={"/brand-asset-profile-picture.png"} alt={"ping-panda avatar"} width={32} height={32}
      ...
      <div className={"flex-1 flex flex-col"}>
        <div className={"h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]"}>
          ...
          <div className={"flex ml-2 items-center"}>
            <div className={"relative"}>
              <Image src={"/brand-asset-profile-picture.png"} alt={"PingPandaAvatar"} width={40} height={40}
                     className={"object-cover rounded-full mr-3"} />

              <div
                className={"absolute bottom-0 right-3 size-3 bg-green-500 rounded-full border-2 border-[#36393f]"}></div>
            </div>
        ...
        <div className={"p-4"}>
          <div className={"flex items-center bg-[#40444b] rounded-lg p-1"}>
            ...
            <input type={"text"} placeholder={"message @PingPanda"}
            ...
            <div className={"flex items-center space-x-3 mx-3 text-[#b9bbbe]"}>
              <Gift className={"hidden sm:block hover:text-white size-5 cursor-not-allowed"} />
              <Sticker className={"hidden sm:block hover:text-white size-5 cursor-not-allowed"} />
              <Smile className={"hidden sm:block hover:text-white size-5 cursor-not-allowed"} />
            </div>
          </div>
        </div>
      </div>
